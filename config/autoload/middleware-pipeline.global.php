...
return [
    'dependencies' => [
        'invokables' => [
            \App\Middleware\JsonBodyMiddleware::class => \App\Middleware\JsonBodyMiddleware::class,
            \App\Middleware\OptionsMiddleware::class => \App\Middleware\OptionsMiddleware::class,
        ],
        'factories' => [
    ...
    'middleware_pipeline' => [
        ...
        'always' => [
            'middleware' => [
                ...
                \App\Middleware\OptionsMiddleware::class,
                \App\Middleware\JsonBodyMiddleware::class
            ],
            'priority' => 10000,
        ],
